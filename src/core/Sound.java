...
public class Sound {
    ...
    public Sound(){
        ...
        soundURL[2] = getClass().getResource("res/sound/Attack.wav");
        soundURL[3] = getClass().getResource("/res/sound/Open.wav");
        soundURL[4] = getClass().getResource("res/sound/Win.wav");
